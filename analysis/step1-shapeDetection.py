...
if __name__=='__main__':
	...
	for i, name in enumerate(ShapeList):
		...
		# draw
		ax.scatter(XCur, YCur, ZCur, s=1, cmap="jet", marker=marker, label=name)
	...
	# set title
	plt.title('Plane Detection with Hough Transformation', fontsize=15)
	...
	# save figure
	plt.savefig('figure_step1_planeDetectionWithHough.png')
